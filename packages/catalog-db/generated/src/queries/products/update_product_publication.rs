...
pub struct UpdateProductPublicationParams {
    pub published: bool,
...
pub fn update_product_publication() -> UpdateProductPublicationStmt {
    UpdateProductPublicationStmt(
        "UPDATE products SET published = $1, published_at = $2, updated_at = $3 WHERE id = $4 RETURNING id, title, handle, description, price_cents, inventory_quantity, published, published_at, created_at, updated_at",
        None,
    )
}
...
impl<'c, 'a, 's, C: GenericClient>
    crate::client::async_::Params<
        ...
        'a,
        's,
        UpdateProductPublicationParams,
        UpdateProductPublicationQuery<'c, 'a, 's, C, UpdateProductPublication, 4>,
        C,
    > for UpdateProductPublicationStmt
{
    fn params(
        &'s self,
        client: &'c C,
        params: &'a UpdateProductPublicationParams,
    ) -> UpdateProductPublicationQuery<'c, 'a, 's, C, UpdateProductPublication, 4> {
        self.bind(
            client,
            &params.published,
